export const MESSAGE = {
    DB: {
        WRONG_ACCOUNT: "Wrong database's username and password",
        WRONG_SERVER: "Wrong server name/connection string",
        FAILED_CONNECT: "Cannot connect to Mongoose",
    },
    USER: {
        LOGIN_SUCCESSFULLY: "Login user successfully",
        WRONG_ACCOUNT: "Wrong email or password",
        EXIST: "User already exists",
        REGISTER_SUCCESSFULLY: "Login user successfully",
        NOT_REGISTER: "Cannot register user",
        GET_LIST_SUCCESSFULLY: "Get user successfully",
        GET_DETAIL_SUCCESSFULLY: "Get detail user successfully",
    },
    STUDENT: {
        GET_LIST_FAILED: "Cannot get student",
